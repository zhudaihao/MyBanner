...
public class BannerLayout extends FrameLayout {
    ...
    protected void initView(Context context, AttributeSet attrs) {
        ...
        if (mSelectedDrawable == null) {
            ...
            selectedGradientDrawable.setColor(getResources().getColor(R.color.click));
        ...
        int marginRight = dp2px(50);
        int marginBottom = dp2px(44);
        int gravity = GravityCompat.END;//调节进度位置（左右）
