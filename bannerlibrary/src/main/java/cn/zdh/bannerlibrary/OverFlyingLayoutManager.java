...
public class OverFlyingLayoutManager extends RecyclerView.LayoutManager
    ...
    private static class SavedState implements Parcelable {
        ...
        public static final Creator<SavedState> CREATOR
            ...
            @Override
            public OverFlyingLayoutManager.SavedState createFromParcel(Parcel in) {
                return new OverFlyingLayoutManager.SavedState(in);
            }

            @Override
            public OverFlyingLayoutManager.SavedState[] newArray(int size) {
                return new OverFlyingLayoutManager.SavedState[size];
            }
        };
    }
